    ...
    <form className='listingform' onSubmit={e => onSubmit(e)}>
      <div className='row'>
        <div className='col-1-of-6'>
          ...
          <div className='listingform__section'>
            <label className='listingform__label' htmlFor='sgft'>Sqft</label>
            <select className='listingform__select' name='sgft' onChange={e => onChange(e)} value={sqft}>
              <option>1000+</option>
              <option>1200+</option>
              <option>1500+</option>
              <option>2000+</option>
        ...
        <div className='col-1-of-6'>
          ...
          <div className='listingform__section'>
            ...
            <input className='listingform__input' name='kewywords' type='text' onChange={e => onChange(e)} value={keywords}/>
          </div>
        </div>
        ...
        <div className='col-1-of-6'>
          ...
          <div className='listingform__altsection'>
            <label className='listingform__label' htmlFor='keywords'>Open Houses</label>
            <input className='listingform__input' name='kewywords' type='checkbox' onChange={e => onChange(e)} value={keywords}/>
          </div>
        </div>
